...
Do NOT infer hidden anatomy.

Do NOT hallucinate internal structures.
...
when these structures are not clearly visible.

Only visible evidence may be used.

--------------------------------------------------
POSITIVE EVIDENCE ONLY
--------------------------------------------------

Classification must rely on POSITIVE evidence.
...
Only visible positive features count.

==================================================
DANGSHEN vs HUANGQI vs FANGFENG
==================================================

These three herbs are commonly confused.

The following features are NOT unique:
...
These features alone cannot identify HuangQi.
